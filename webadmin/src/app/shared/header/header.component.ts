...
export class HeaderComponent implements OnInit {
  ...
  constructor(public commonService:CommonService,public headerVar: HeaderVar,private headerService: HeaderService,private breadCrumbService : BreadCrumbService,private http: HttpService,public router:Router,public authGuard:AuthGuard) { 
