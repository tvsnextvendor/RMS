...
module.exports = (sequelize, DataTypes) => {
    ...
    User.associate = (models) => {
        ...
        User.hasMany(models.CertificateUserMapping, { foreignKey: 'userId', onDelete: 'cascade' });
        User.hasMany(models.TrainingScheduleResorts, { foreignKey: 'userId', onDelete: 'cascade' })
